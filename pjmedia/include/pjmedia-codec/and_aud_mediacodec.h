...
#ifndef __PJMEDIA_CODEC_AUD_ANDMEDIACODEC_H__
#define __PJMEDIA_CODEC_AUD_ANDMEDIACODEC_H__
 ...
 */
PJ_DECL(pj_status_t) pjmedia_codec_anmed_aud_init( pjmedia_endpt *endpt );
 ...
 * @return	    PJ_SUCCESS on success.
 */
PJ_DECL(pj_status_t) pjmedia_codec_anmed_aud_deinit( void );
...
#endif	/* __PJMEDIA_CODEC_AUD_ANDMEDIACODEC_H__ */
